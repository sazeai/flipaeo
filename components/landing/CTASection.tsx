      ...
      <div className="relative group">
        ...
        <div className="hidden md:block absolute inset-0 pointer-events-none">
          ...
          <div className="absolute -top-8 -left-[200px] w-48 flex flex-col items-end">
            <span className="font-hand text-2xl text-stone-500 mb-1 leading-none">Get cited by <br />ChatGPT & Gemini</span>
          ...
          <div className="absolute -top-8 -right-[200px] w-48 flex flex-col items-start">
            <span className="font-hand text-2xl text-stone-500 mb-1 rotate-6 leading-none">Become the AI's 'Source of Truth'</span>
          ...
          <div className="absolute top-[110%] -left-[110px] w-56 flex flex-col items-center">
            <span className="text-stone-500 rotate-90">
              <svg width="39" height="43" viewBox="0 0 39 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M35.3098 41.3831C38.805 33.6161 39.7653 17.8871 22.106 16.5287C12.0089 15.752 15.1157 28.9559 24.4361 27.4025C32.203 26.108 39.5817 5.6549 1.52344 4.1015M1.52344 4.1015L4.63023 7.59665M1.52344 4.1015L5.40693 1.38305" stroke="#767676ff" strokeWidth="2" strokeLinecap="round" />
              </svg>
            </span>
            <span className="font-hand text-2xl text-stone-500 leading-none text-center">
          ...
          <div className="absolute top-[110%] left-1/2 -translate-x-1/2 w-56 flex flex-col items-center">
            ...
            <span className="font-hand text-2xl text-center text-stone-500 leading-none">Publish content <br /> on autopilot</span>
          </div>

          {/* 5. Bottom Right: Increase conversion */}
          <div className="absolute top-[110%] -right-[110px] w-56 flex flex-col items-center">
